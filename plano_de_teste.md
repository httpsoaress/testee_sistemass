...
- Integração entre módulos  
  *(ex: exclusão de bairro removendo avaliações e comentários)*
...
- **Arthur Michelangelo, Enya Sofia, Nicolly Soares** – Validação de regras de negócio
- **Leandro Rivas, Arthur Michelangelo, Gabriel Oliveira, Enya Sofia, Nicolly Soares** – Revisão final e validação geral